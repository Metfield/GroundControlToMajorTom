...
////// Lighting:
////// Emissive:
                float3 node_1494 = (_AtmosphereColor.rgb*10.0*pow(saturate(dot(i.normalDir,viewDirection)),_Atmospherecircle));
